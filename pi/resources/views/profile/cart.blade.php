                                                    ...
                                                    <td>
                                                        <div class="table-p__input-counter-wrap">
                                                            ...
                                                            <div class="input-counter">
                                                                ...
                                                                <span
                                                                    class="input-counter__minus fas fa-minus buttonToAddOrGetOut"></span>
                                                                ...
                                                                <span
                                                                    class="input-counter__plus fas fa-plus buttonToAddOrGetOut"></span>
                                                            </div>
                                                            <!--====== End - Input Counter ======-->
                                                        </div>
                                                    </td>
                        ...
                        <div class="col-lg-12">
                            <div class="route-box">
                                <div class="route-box__g1">
                                    ...
                                    <a class="route-box__link" href="search?CATEGORIA_ID={{ $item->produto->categoria->CATEGORIA_ID }}"><i
