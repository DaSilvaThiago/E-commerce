                                    ...
                                    <form class="checkout-f__delivery">
                                        <div class="u-s-m-b-30">
                                            <div class="u-s-m-b-15">
                                                ...
                                                <div class="check-box">
                                                    ...
                                                    <div class="check-box__state check-box__state--primary">
                                                        ...
                                                        <label class="check-box__label" for="get-address">Usar endereço ja cadastrado</label></div>
                                                </div>
                                                <!--====== End - Check Box ======-->
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <button class="btn btn--e-transparent-brand-b-2" type="submit">SALVAR</button></div>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-lg-6">
