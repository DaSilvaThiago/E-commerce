                                            ...
                                            <div class="dash__pad-1">
                                                ...
                                                <ul class="dash__f-list">
                                                    <li>
                                                        ...
                                                        <a class="dash-active" href="dashboard.html">Gerenciar Perfil</a></li>
                                                    <li>
    
                                                        <a href="dash-my-profile.html">Meu Perfil</a></li>
                                                    <li>
    
                                                        <a href="dash-address-book.html">Endereços</a></li>
                                                    <li>
    
                                                        <a href="dash-my-order.html">Meus Pedidos</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="dash__w-list">
                                                    <li>
                                                        <div class="dash__w-wrap">
                                                            ...
                                                            <span class="dash__w-name">Pedidos Feitos</span></div>
                                                    </li>
                                                    <li>
                                                        <div class="dash__w-wrap">
                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                            <div class="dash__pad-2">
                                                ...
                                                <span class="dash__text u-s-m-b-30">Desse Dashboard você gerencia as atividades da sua conta e atualiza suas infromações. Clique em algum link abaixo.</span>
                                                <div class="row">
                                                        ...
                                                        <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                            <div class="dash__pad-3">
                                                                ...
                                                                <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                                    ...
                                                                    <a href="dash-edit-profile.html">Editar</a></div>
                                                        ...
                                                        <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                            <div class="dash__pad-3">
                                                                ...
                                                                <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                                    ...
                                                                    <a href="dash-address-book.html">Editar</a></div>
